...
public enum SQLConn {
	INSTANCE;
	private static final String url = "jdbc:sqlserver://192.168.0.6; databaseName=pos;useUnicode=true;characterEncoding=utf-8";
	...
	public Statement getSqlStatement(String urlpassing) throws SQLException {
		Statement stmt = null;
		urlpassing = "jdbc:sqlserver://192.168.0.6; databaseName="+urlpassing+";useUnicode=true;characterEncoding=utf-8";
